...
void main() {
  ...
  test('evaluation log level info', () async {
    ...
    // Act
    final String value = await client.getValue(key: 'stringContainsDogDefaultCat', defaultValue: 'default');
  ...
  test('evaluation log level warning', () async {
    ...
    final client = ConfigCatClient.get(
        ...
        options: ConfigCatOptions(
          logger:
          ConfigCatLogger(internalLogger: testLogger, level: LogLevel.warning),
          pollingMode: PollingMode.manualPoll(),
        ));
