...
class EvaluateLogger {
  ...
  void logUserObject(final ConfigCatUser user) {
    append(" for User '$user'");
  }

  void logEvaluation(String key) {
    append("Evaluating '$key'");
  }

  void logPercentageOptionUserMissing() {
    newLine();
    append("Skipping % options because the User Object is missing.");
  }

  void logPercentageOptionUserAttributeMissing(
  ...
  void logPercentageOptionEvaluation(String percentageOptionsAttributeName) {
    newLine();
    append(
        "Evaluating % options based on the User.$percentageOptionsAttributeName attribute:");
  }

  void logPercentageOptionEvaluationHash(
  ...
  void logReturnValue(String returnValue) {
    newLine();
    append("Returning '$returnValue'.");
  }

  void logTargetingRules() {
    newLine();
    append("Evaluating targeting rules and applying the first match if any:");
  }

  void logConditionConsequence(bool result) {
    append(" => $result");
    if (!result) {
  ...
  void logTargetingRuleConsequence(TargetingRule targetingRule, String? error,
  ...
  void logPercentageEvaluationReturnValue(
  ...
  void logSegmentEvaluationStart(String segmentName) {
    newLine();
    append("(");
    increaseIndentLevel();
    newLine();
  ...
  void logSegmentEvaluationError(
  ...
  void logPrerequisiteFlagEvaluationStart(String prerequisiteFlagKey) {
    newLine();
    append("(");
    increaseIndentLevel();
    newLine();
  ...
  void logPrerequisiteFlagEvaluationResult(
